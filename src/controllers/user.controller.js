import { User } from "../models/user.authorisation.js";
...
export const SignUp = asyncWrapper(async (req, res, next) => {
    ...
    const hashedPassword = await bcryptjs.hashSync(req.body.password, 15);

    // Generating OTP
    const otp = otpGenerator();
    const otpExpirationDate = new Date().getTime() + (60 * 1000 * 7);
    //the otp expires in seven minutes 
